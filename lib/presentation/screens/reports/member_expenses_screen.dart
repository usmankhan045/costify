...
class _MemberExpensesScreenState extends ConsumerState<MemberExpensesScreen> {
  ...
  Widget build(BuildContext context) {
      ...
      expensesAsync.when(
        data: (expenses) {
          final filteredExpenses = expenses.where((expense) {
            // Use displayUserId to include expenses added by admin on behalf of user
            return expense.displayUserId == widget.userId &&
    ...
    final groupedExpenses = groupExpensesByDate(memberExpenses);
